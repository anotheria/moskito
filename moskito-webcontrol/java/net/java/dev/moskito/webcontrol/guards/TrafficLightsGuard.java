...
import net.java.dev.moskito.webcontrol.guards.rules.GreenRule;
import net.java.dev.moskito.webcontrol.guards.rules.RedRule;
import net.java.dev.moskito.webcontrol.guards.rules.Rule;
import net.java.dev.moskito.webcontrol.guards.rules.YellowRule;
