 ...
 * 
 * The following configuration is supported (this configures local XML storage): { className: "net.java.dev.moskito.central.storages.SynchroneousConnector",
 * archiversConstructorMoreParams: "", storageClassName: "net.java.dev.moskito.central.storages.XmlStatStorage", storageParams: "", hostName: "thishost.net" }
 * 
 * The following assumptions are made concerning ISnapshotArchiver implementations.
 * 
 * <ul>
 * <li>SynchroneousConnector (ISnapshotArchiver implementation in a more common case) accepts storage instance as first param and optionally can accept more
 * params of type String.</li>
 ...
 * <li>archiversConstructorMoreParams - specifies additional comma-separated list of String params for the archiver constructor, in case of empty string it is
 * assuned that the constructor has no additional string params</li>
 ...
 * <li>hostName - is used to specify host name of the machine that produces the stats. Archivers do store this information too. The hostName parameter is
 * optional in the config file. If it is ommited the host name is autodetected. But if it fails to autodetect then RuntimeException is thrown</li>
 * </ul>
 * 
...
public final class SnapshotArchiverConfig {
	...
	private static SnapshotArchiverConfig instance = null;

	public static synchronized SnapshotArchiverConfig createInstance() {
		if (instance == null) {
