...
.main {margin:101px 10px 0 10px; min-width:960px;}
...
.top ul li .sub_menu {position:absolute; top:50px; height:auto; overflow:hidden; background:url(../img/bgs.gif) 0 -533px no-repeat; left:150px; display:none;}
.top ul li .over_color {display:none;}
.top ul li.active .over_color {display:block;} 
.top ul li .sub_menu ul {margin:0; margin-left:5px; white-space:nowrap; padding-right:5px; background:url(../img/bgs.gif) 100% -602px no-repeat;}
.top ul li .sub_menu ul li {display:block; float:left; list-style-type:none; padding:7px 11px; background:url(../img/bgs.gif) 0 -669px repeat-x;}
...
.top ul li.active .sub_menu {display:block;}
...
.table_itseft .in table td, .table_itseft .in table th {text-align:left; font-size:1.2em; padding:5px 20px 5px 5px; white-space:nowrap;}
...
.table_itseft .in table tr.even td {background:#f7f7f7;}
...
.table_right tbody td {cursor:default;}

.generated {font-size:1.2em; color:#666666; margin-bottom:1em;}
h2 {margin-top:-4px; height:20px; display:block;}
h2 a {font-size:1.1em; color:black; padding-left:17px; background:url(../img/bgs.gif) 0 -1073px no-repeat; line-height:1.1em;}
...
.help {float:right; font-size:1.2em;}
