...
@SuiteClasses({ServiceStatsParallelTest.class, ServiceStatsSimpleTest.class, IntervalNameParserTest.class, RequestOrientedStatsTest.class, NegativeCurrentRequestsTest.class})
