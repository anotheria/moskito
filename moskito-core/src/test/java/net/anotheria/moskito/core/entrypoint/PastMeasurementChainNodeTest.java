...
public class PastMeasurementChainNodeTest {
    ...
    @Test
    public void testRemoveFirstPastMeasurementByItsPosition() {
    ...
    @Test
    public void testRemovePastMeasurementByItsPositionFromMiddle() {
        ActiveMeasurement firstActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement secondActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement thirdActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement forthActiveMeasurement = new ActiveMeasurement("producer");
    ...
    @Test
    public void testRemoveLastPastMeasurementByItsPosition() {
        ActiveMeasurement firstActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement secondActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement thirdActiveMeasurement = new ActiveMeasurement("producer");
        ActiveMeasurement forthActiveMeasurement = new ActiveMeasurement("producer");
    ...
    public void testInsertCase2() {
        ...
        //build chain.
        PastMeasurementChainNode first = new PastMeasurementChainNode(am);
        first.unitTestSetEndTime(System.currentTimeMillis() + 100);
        PastMeasurementChainNode second = new PastMeasurementChainNode(am);
        second.unitTestSetEndTime(System.currentTimeMillis() + 100);
        PastMeasurementChainNode third = new PastMeasurementChainNode(am);
        third.unitTestSetEndTime(System.currentTimeMillis() + 100);
    ...
    public void testInsertCase5() {
        ...
        //build chain.
        for (int i = 0; i < 30; i++) {
            PastMeasurementChainNode node = new PastMeasurementChainNode(am);
            node.unitTestSetEndTime(System.currentTimeMillis() + 100);
