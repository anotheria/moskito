...
public class ThresholdAPIImpl extends AbstractMoskitoAPIImpl implements ThresholdAPI{
	...
	public List<ThresholdAlertAO> getAlerts() {
		...
		for (ThresholdAlert alert : alerts){
			...
			if (alert.getNewStatus()!=null) {
				...
				alertBean.setNewColorCode(ThresholdStatus.OFF.name().toLowerCase());
	...
	public List<ThresholdStatusAO> getThresholdStatuses() throws APIException {
		...
		for (Threshold t : thresholds){
			...
			if (t.getPreviousStatus()==null){
				statusAO.setPreviousColorCode(ThresholdStatus.OFF.name());
				statusAO.setPreviousStatus(ThresholdStatus.OFF.name());
			}else {
