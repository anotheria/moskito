...
<p>
	<h3><a name="<bean:write name="decorator" property="name"/>"><bean:write name="decorator" property="name"/></a></h3>
	<table width="100%" cellpadding="4" cellspacing="0" border="0" >
		...
		<logic:iterate name="decorator" property="captions" id="caption" type="net.java.dev.moskito.webui.bean.StatCaptionBean" indexId="index">
			<tr class="<%= ((index & 1) == 0 )? "stat_even" : "stat_odd" %>">
				<td><bean:write name="caption" property="caption"/></td>
				<td><bean:write name="caption" property="shortExplanation"/></td>
				<td><bean:write name="caption" property="explanation"/></td>
			</tr>
		</logic:iterate>
	</table> 
	<br/>	
