...
<metadata>
	...
	<producers>
    <ano:iterate name="producerAndTypes" id="producer" type="net.anotheria.moskito.webui.bean.ProducerAndTypeBean">
	...
	<types>
    <ano:iterate name="typeAndValueNames" id="type" type="net.anotheria.moskito.webui.bean.TypeAndValueNamesBean">
