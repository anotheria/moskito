...
<producers>
  ...
  <msk:iterate type="net.anotheria.moskito.webui.bean.ProducerDecoratorBean" id="decorator" name="decorators">
	...
	--%><msk:iterate name="decorator" property="producers" id="producer" type="net.anotheria.moskito.webui.bean.ProducerBean">
          <producer id="<msk:write name="producer" property="id" filter="true"/>">
            ...
            <values>
			<msk:iterate name="producer" property="values" id="value" type="net.anotheria.moskito.webui.bean.StatValueBean" indexId="ind"><%
  ...
  <chartdata>
	...
	<chart name="<msk:write name="graph" property="caption" filter="true"/>" id="<msk:write name="graph" property="jsVariableName" filter="true"/>">
		<msk:iterate name="graph" property="values" id="value" type="net.anotheria.moskito.webui.bean.GraphDataValueBean">
