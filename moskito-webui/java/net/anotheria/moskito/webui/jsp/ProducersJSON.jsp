...
%>{
    ...
    <ano:iterate type="net.anotheria.moskito.webui.bean.ProducerDecoratorBean" id="decorator" name="decorators"><ano:define name="decorator" property="captions" type="java.util.List" id="captions"/>
    "<ano:write name="decorator" property="name"/>" : {
		<ano:iterate name="decorator" property="producers" id="producer" type="net.anotheria.moskito.webui.bean.ProducerBean">
		          "<ano:write name="producer" property="id"/>": {
		            ...
		            values: [
					<ano:iterate name="producer" property="values" id="value" type="net.anotheria.moskito.webui.bean.StatValueBean" indexId="ind"><%
		...
		chartdata: [
			<ano:iterate type="net.anotheria.moskito.webui.bean.GraphDataBean" id="graph" name="graphDatas">
			{
				...
				values: [
				<ano:iterate name="graph" property="values" id="value" type="net.anotheria.moskito.webui.bean.GraphDataValueBean">
