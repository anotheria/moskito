...
%>
{
	"intervals": [<ano:iterate name="intervals" id="interval" type="net.anotheria.moskito.webui.shared.bean.IntervalBean" indexId="intIndex"><ano:notEqual name="intIndex" value="0">,</ano:notEqual>"<ano:write name="interval" property="name"/>"</ano:iterate>],
   	"units": [<ano:iterate name="units" id="unit" type="net.anotheria.moskito.webui.shared.bean.UnitBean" indexId="unitIndex"><ano:notEqual name="unitIndex" value="0">,</ano:notEqual>"<ano:write name="unit" property="unitName"/>"</ano:iterate>],
  	"producers": [
    <ano:iterate name="producerAndTypes" id="producer" type="net.anotheria.moskito.webui.shared.bean.ProducerAndTypeBean" indexId="producersIndex"><ano:notEqual name="producersIndex" value="0">,</ano:notEqual>
		{
