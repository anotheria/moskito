...
<script type="text/javascript">
	<ano:iterate name="singleGraphData" type="net.anotheria.moskito.webui.shared.bean.AccumulatedSingleGraphDataBean" id="singleGraph">
				...
				<div class="in">
					...
					<form action="" method="GET">
						<table class="accumulators_table" cellpadding="0" cellspacing="0" width="100%">
							...
							<tbody>
							<ano:iterate name="accumulators" type="net.anotheria.moskito.webui.shared.bean.AccumulatorInfoBean" id="accumulator" indexId="index">
