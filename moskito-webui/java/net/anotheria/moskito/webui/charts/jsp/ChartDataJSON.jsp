...
%>{
	...
	"data": [<msk:iterate name="data" id="entity" type="net.anotheria.moskito.webui.charts.bean.ChartDataEntityBean" indexId="i"><msk:notEqual name="i" value="0">,</msk:notEqual>{
