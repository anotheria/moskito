	...
	<div class="white_pl">
		<div class="top">
			<div class="left_bg"><!-- --></div>
						...
						<ul>
							<msk:present name="intervals" scope="request">
								<li>
									...
									<select onchange="javascript:handleSelect(this)">									
							 			<jsp:include page="../../shared/jsp/IntervalSelection.jsp" flush="false" />			
									</select>								
								</li>
							</msk:present>
							<msk:present name="units" scope="request">
								<li>	
									<span>Unit:</span>
									<select onchange="javascript:handleSelect(this)">									
										<jsp:include page="../../shared/jsp/UnitSelection.jsp" flush="false" />
									</select>
								</li>
							</msk:present>							
							<msk:present name="categories" scope="request">
								<li>								
									<span>Category:</span>
									<select onchange="javascript:handleSelect(this)">
										<jsp:include page="../../shared/jsp/CategorySelection.jsp" flush="false" />
									</select>							
								</li>
						    </msk:present>
							...
							<msk:present name="subsystems" scope="request">
								<li class="separator">								
									<span>Subsystem:</span>
									<select onchange="javascript:handleSelect(this)">
										<jsp:include page="../../shared/jsp/SubsystemSelection.jsp" flush="false" />
									</select>								
								</li>
							</msk:present>
						</ul>
				...
				<div class="right"></div>
				<jsp:include page="../../shared/jsp/ExportMenu.jsp" flush="false" />
		</div>
	</div>
</div>