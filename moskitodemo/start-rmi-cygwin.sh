...
#./start-rmi-cygwin.sh net.anotheria.moskito.central.demo.TestLocalClient
#./start-rmi-cygwin.sh net.anotheria.moskito.central.demo.generated.IDemoServer
#./start-rmi-cygwin.sh net.anotheria.moskito.central.demo.TestRemoteClient

#./start-rmi-cygwin.sh net.anotheria.moskito.central.generated.StatStorageServer