...
/**
 * Aspect used to intercept @Monitor annotated classes or method calls.
 *
 * @author <a href="mailto:vzhovtiuk@anotheria.net">Vitaliy Zhovtiuk</a>, lrosenberg
 */
@Aspect
public class MonitorAspect extends AbstractMoskitoAspect<ServiceStats>{
...
/*
  ...
  */
    private Object doProfiling(ProceedingJoinPoint pjp, String aProducerId, String aSubsystem, String aCategory) throws Throwable {
		...
		OnDemandStatsProducer<ServiceStats> producer = getProducer(pjp, aProducerId, aCategory, aSubsystem, false, ServiceStatsFactory.DEFAULT_INSTANCE);
